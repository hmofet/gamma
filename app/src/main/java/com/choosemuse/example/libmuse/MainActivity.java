...
public class MainActivity extends Activity implements OnClickListener {
    ...
    final String[] freq = new String[1];
    ...
    private final int PERMISSIONS_REQUEST_READ_INTERNET =1;
        ...
        if (ContextCompat.checkSelfPermission(this,
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this,
                ...
                ActivityCompat.requestPermissions(this,
                        ...
                        PERMISSIONS_REQUEST_READ_INTERNET);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.refresh) {
            ...
            final String mmse = "testuser," + ans1.getText() + "," + ans2.getText() + ","  + ans3.getText() + "," + ans4.getText() + "," + ans5.getText()+","+
                    time+"\n";
    ...
    private void initUI() {
        ...
        Button submitButton = (Button) findViewById(R.id.submitMmse);
        ...
        timer.schedule(new TimerTask() {
            @Override
            public void run() {
                String freqUrl = "http://yyee.ca/gamma2hard/freq.php";
                RequestQueue queue = Volley.newRequestQueue(MainActivity.this);

                StringRequest stringRequest = new StringRequest(Request.Method.GET, freqUrl,
                        new Response.Listener<String>() {
                            @Override
                            public void onResponse(String response) {
